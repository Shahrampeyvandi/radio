                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="name" id="original-title" 
                                    ...
                                    onblur="checkName(event,'<?php echo e(route('Panel.checkNameAjax')); ?>')">
    ...
    left: 47%;">0%</span>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a class="btn btn-outline-primary" href="<?php echo e(route('Panel.MoviesList')); ?>">بازگشت &nbsp;<i
...
<script src="<?php echo e(asset('assets/js/tus.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/tus-example.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\radio\resources\views/Panel/Movies/add.blade.php ENDPATH**/ ?>