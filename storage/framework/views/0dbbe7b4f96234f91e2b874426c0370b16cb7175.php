        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style="padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;"><?php echo e($music); ?><sup style="font-size: 20px"></sup>
                        </h3>
                        <p class="text-white fs-1-5">موزیک</p>
                    </div>
                    <div class="fs-2">
        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style="padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;"><?php echo e($video); ?><sup style="font-size: 20px"></sup>
                        </h3>
                        <p class="text-white fs-1-5">ویدیو </p>
                    </div>
                    <div class="fs-2">
                        <i class="fas fa-2x fa-radiation-alt"></i>
                    </div>
...
<script>
    ...
    type: 'bar',
    data: {
        labels: ['ahang1','ahang2','ahang3','ahang4'],
        datasets: [{
            label: 'آهنگ  های پرطرفدار این هفته',
            data: ['20','30','19','14'],
            backgroundColor: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\radio\resources\views/Panel/Dashboard.blade.php ENDPATH**/ ?>