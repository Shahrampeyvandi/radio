...
<div class="side-menu">
    <div class="side-menu-body">
        <ul>
           ...
           <li><a href="<?php echo e(route('Panel.VideoList')); ?>"><i class="fas fa-video"></i> <span class="pr-4">ویدئو</span> </a>
            </li>
            ...
            <li><a href="<?php echo e(route('Panel.GalleryList')); ?>"><i class="fas fa-image"></i> <span class="pr-4">گالری تصاویر</span> </a>
            </li>
            <li><a href="<?php echo e(route('Panel.ArtistList')); ?>"><i class="fas fa-user"></i> <span class="pr-4">Artists</span> </a>
            </li>
...
<!-- end::side menu --><?php /**PATH C:\xampp1\htdocs\radio\resources\views/Includes/Panel/side-menu.blade.php ENDPATH**/ ?>